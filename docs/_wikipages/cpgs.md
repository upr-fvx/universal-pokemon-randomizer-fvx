...
![the randomizer's root folder, with data/ highlighted]({{ img_dir }}/nav1.png)

![the data/ folder, with players/ highlighted]({{ img_dir }}/nav2.png)

![the players/ folder, with snorlax/ highlighted]({{ img_dir }}/nav3.png)

![the snorlax/ folder, showing image files and info.ini]({{ img_dir }}/nav4.png)
...
[Showcase gif]({{ img_dir }}/gen1/showcase.gif)
...
![a colored source image]({{ img_dir }}/gen1/mario_walk_colored.png) or ![a monochrome source image]({{ img_dir }}/gen1/mario_walk.png) &rarr; ![a screenshot of the resulting sprite in-game]({{ img_dir }}/gen1/mario_screenshot.png)
...
![front image #1]({{ img_dir }}/gen1/red_front.png)
![front image #2]({{ img_dir }}/gen1/blackmage_front.png)
![front image #3]({{ img_dir }}/gen1/snorlax_front.png)
![front image #4]({{ img_dir }}/gen1/mario_front.png)
![back image #1]({{ img_dir }}/gen1/red_back.png)
![back image #2]({{ img_dir }}/gen1/blackmage_back.png)
![back image #3]({{ img_dir }}/gen1/snorlax_back.png)
![back image #4]({{ img_dir }}/gen1/mario_back.png)
...
![walk sprite #1]({{ img_dir }}/gen1/red_walk.png)
![walk sprite #2]({{ img_dir }}/gen1/blackmage_walk.png)
![walk sprite #3]({{ img_dir }}/gen1/snorlax_walk.png)
![walk sprite #4]({{ img_dir }}/gen1/mario_walk.png)
![bike sprite #1]({{ img_dir }}/gen1/red_bike.png)
![bike sprite #2]({{ img_dir }}/gen1/blackmage_bike.png)
![bike sprite #3]({{ img_dir }}/gen1/snorlax_bike.png)
![bike sprite #4]({{ img_dir }}/gen1/mario_bike.png)
...
![walk sprite with the part seen in screenshot highlighted]({{ img_dir }}/gen1/red_walk_highlight.png) + 
![fishing sprite with the part seen in screenshot highlighted]({{ img_dir }}/gen1/red_fish_highlight.png) &rarr;
![screenshot of the player fishing ]({{ img_dir }}/gen1/fishing_screenshot.png)
...
![fishing sprite separate #1-front]({{ img_dir }}/gen1/red_fish_front.png)
![fishing sprite separate #1-back]({{ img_dir }}/gen1/red_fish_back.png)
![fishing sprite separate #1-side]({{ img_dir }}/gen1/red_fish_side.png),
![fishing sprite separate #2-front]({{ img_dir }}/gen1/blackmage_fish_front.png)
![fishing sprite separate #2-back]({{ img_dir }}/gen1/blackmage_fish_back.png)
![fishing sprite separate #2-side]({{ img_dir }}/gen1/blackmage_fish_side.png),
![fishing sprite separate #3-front]({{ img_dir }}/gen1/snorlax_fish_front.png)
![fishing sprite separate #3-back]({{ img_dir }}/gen1/snorlax_fish_back.png)
![fishing sprite separate #3-side]({{ img_dir }}/gen1/snorlax_fish_side.png),
![fishing sprite separate #4-front]({{ img_dir }}/gen1/mario_fish_front.png)
![fishing sprite separate #4-back]({{ img_dir }}/gen1/mario_fish_back.png)
![fishing sprite separate #4-side]({{ img_dir }}/gen1/mario_fish_side.png),
![fishing sprite combined #1]({{ img_dir }}/gen1/red_fish.png)
![fishing sprite combined #2]({{ img_dir }}/gen1/blackmage_fish.png)
![fishing sprite combined #3]({{ img_dir }}/gen1/snorlax_fish.png)
![fishing sprite combined #4]({{ img_dir }}/gen1/mario_fish.png)
...
![a screenshot of the Pokémon Blue title screen]({{ img_dir }}/gen1/title_screen_screenshot.png)
![the fishing rod sprite]({{ img_dir }}/gen1/fishing_rod.png)

---

## In Generation 2

[Showcase gif]({{ img_dir }}/gen2/showcase.gif)
...
![a colored source image]({{ img_dir }}/gen2/other_walk.png) or ![a monochrome source image]({{ img_dir }}/gen2/other_walk_monochrome.png) &rarr;
![a screenshot of the resulting sprite in-game]({{ img_dir }}/gen2/other_screenshot.png)
...
![front image #1]({{ img_dir }}/gen2/kris_front.png)
![front image #2]({{ img_dir }}/gen2/other_front.png)
![back image #1]({{ img_dir }}/gen2/kris_back.png)
![back image #2]({{ img_dir }}/gen2/other_back.png)
![trainer card image #1]({{ img_dir }}/gen2/kris_trainer_card.png)
![trainer card image #2]({{ img_dir }}/gen2/other_trainer_card.png)
...
![walk sprite #1]({{ img_dir }}/gen2/kris_walk.png)
![walk sprite #2]({{ img_dir }}/gen2/other_walk.png)
![bike sprite #1]({{ img_dir }}/gen2/kris_bike.png)
![bike sprite #2]({{ img_dir }}/gen2/other_bike.png)

Like the walk and bike sprites, the fishing sprite has frames for the directions up/down/side. However, they only have 1 frame for each direction, 
and this frame only covers the bottom half of what is seen on screen. The top half is taken from the walk sprite frame facing the appropriate direction.

![walk sprite with the part seen in screenshot highlighted]({{ img_dir }}/gen2/kris_walk_highlight.png) + 
![fishing sprite with the part seen in screenshot highlighted]({{ img_dir }}/gen2/kris_fish_highlight.png) &rarr;
![screenshot of the player fishing ]({{ img_dir }}/gen2/fishing_screenshot.png)

The UPR can read fishing sprites in two "modes". With the "separate" mode, each frame will be read from a separate 8x16 pixel image. 
With the "combined" mode, all frames will be read from a single 16x24 pixel image. Examples of valid fishing sprites below:

![fishing sprite separate #1-front]({{ img_dir }}/gen2/kris_fish_front.png)
![fishing sprite separate #1-back]({{ img_dir }}/gen2/kris_fish_back.png)
![fishing sprite separate #1-side]({{ img_dir }}/gen2/kris_fish_side.png),
![fishing sprite separate #2-front]({{ img_dir }}/gen2/other_fish_front.png)
![fishing sprite separate #2-back]({{ img_dir }}/gen2/other_fish_back.png)
![fishing sprite separate #2-side]({{ img_dir }}/gen2/other_fish_side.png),
![fishing sprite combined #1]({{ img_dir }}/gen2/kris_fish.png)
![fishing sprite combined #2]({{ img_dir }}/gen2/other_fish.png)
...
![the fishing rod sprite]({{ img_dir }}/gen2/fishing_rod.png)
...
![front image #1]({{ img_dir }}/gen3/may_front.png)
![front image #2]({{ img_dir }}/gen3/red_front.png)
![back image #1]({{ img_dir }}/gen3/may_back.png)
![back image #2]({{ img_dir }}/gen3/red_back.png)

The map icon image is 16x16 pixels. Examples of valid map icon images below.

![trainer map icon image #1]({{ img_dir }}/gen3/may_icon.png)
![trainer map icon image #2]({{ img_dir }}/gen3/red_icon.png)

The walk sprite is 144x32 pixels, split into 9 frames of 16x32 pixels each. 
Examples of valid walk sprites below:

![walk sprite #1]({{ img_dir }}/gen3/may_walk.png)
![walk sprite #2]({{ img_dir }}/gen3/red_walk.png)
...
![run sprite #1]({{ img_dir }}/gen3/may_run.png)
![run sprite #2]({{ img_dir }}/gen3/red_run.png)
...
![bike sprite #1]({{ img_dir }}/gen3/may_bike.png)
![bike sprite #2]({{ img_dir }}/gen3/red_bike.png)

The fishing sprite is 384x32 pixels, split into 12 frames of 32x32 pixels each. Examples of valid fishing sprites below:

![fishing sprite #1]({{ img_dir }}/gen3/may_fish.png)
![fishing sprite #2]({{ img_dir }}/gen3/red_fish.png)
...
![sit sprite #1]({{ img_dir }}/gen3/may_sit.png)
![sit sprite #2]({{ img_dir }}/gen3/red_sit.png)
...
![surf blob sprite #1]({{ img_dir }}/gen3/may_surfblob.png)
![surf blob sprite #2]({{ img_dir }}/gen3/red_surfblob.png)
...
![bird sprite #1]({{ img_dir }}/gen3/may_bird.png)
![bird sprite #2]({{ img_dir }}/gen3/red_bird.png)
...
![sit/jump sprite #1]({{ img_dir }}/rse/may_sitjump.png)
![sit/jump sprite #2]({{ img_dir }}/rse/brendan_sitjump.png)

The acro bike sprite is 864x32 pixels, split into 27 frames of 32x32 pixels each. Examples of valid sit/jump sprites below:

![acro bike sprite #1]({{ img_dir }}/rse/may_acrobike.png)
![acro bike sprite #2]({{ img_dir }}/rse/brendan_acrobike.png)
...
![underwater sprite #1]({{ img_dir }}/rse/may_underwater.png)
![underwater sprite #2]({{ img_dir }}/rse/brendan_underwater.png)
...
![watering can sprite #1]({{ img_dir }}/rse/may_wateringcan.png)
![watering can sprite #2]({{ img_dir }}/rse/brendan_wateringcan.png)

The decorate sprite is 16x32 pixels, with a single frame. Examples of valid decorate sprites below:

![decorate sprite #1]({{ img_dir }}/rse/may_decorate.png)
![decorate sprite #2]({{ img_dir }}/rse/brendan_decorate.png)
...
![field move sprite #1]({{ img_dir }}/rse/may_fieldmove.png)
![field move sprite #2]({{ img_dir }}/rse/brendan_fieldmove.png)
...
![intro brendan (ruby/sapphire)]({{ img_dir }}/rse/brendan_introbike_RS.png)
![intro may (ruby/sapphire)]({{ img_dir }}/rse/may_introbike_RS.png)
![intro brendan (emerald)]({{ img_dir }}/rse/brendan_introbike_E.png) 
![intro may (emerald)]({{ img_dir }}/rse/may_introbike_E.png)
![the bike itself (ruby/sapphire)]({{ img_dir }}/rse/introbike_RS.png)
![the bike itself (emerald)]({{ img_dir }}/rse/introbike_E.png)
...
![field move sprite #1]({{ img_dir }}/frlg/leaf_item.png)
![field move sprite #2]({{ img_dir }}/frlg/red_item.png)
...
![field move sprite #1]({{ img_dir }}/frlg/leaf_itembike.png)
![field move sprite #2]({{ img_dir }}/frlg/red_itembike.png)
...
![the player select red image]({{ img_dir }}/frlg/red_playerselect.png)
![the player select leaf image]({{ img_dir }}/frlg/leaf_playerselect.png)
