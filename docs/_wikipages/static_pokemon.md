...
Under normal circumstances, "Similar Strength" settings start looking for replacements within a 10% BST range up and down (more information can be found [here](https://github.com/upr-fvx/universal-pokemon-randomizer-fvx/wiki/Pokemon-Base-Statistics#similar-strength)). When this setting is activated, the following changes are made when randomizing the affected Pokemon:
