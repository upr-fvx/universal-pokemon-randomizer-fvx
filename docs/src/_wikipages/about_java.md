...
<!-- Is this even liable to happen, now that the Randomizer uses a Java runtime image? Might want to delete this section. !-->
...
**NOTE: the below applies only to Randomizer versions up to v1.4.2a. Newer Randomizer versions come packaged with the Java they need.**

---

## Java requirements for older Randomizer versions
...
## Java Downloads for older Randomizer versions
