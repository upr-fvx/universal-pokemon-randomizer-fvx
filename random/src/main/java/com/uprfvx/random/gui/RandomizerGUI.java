...
public class RandomizerGUI {
    ...
    private SettingsManager createSettingsFromState() {
        ...
        settings.setStandardizeEXPCurves(secStandardizeEXPCurvesCheckBox.isSelected());
        settings.setExpCurveMod(secLegendariesSlowRadioButton.isSelected(), secStrongLegendariesSlowRadioButton.isSelected(),
                secAllSpeciesRadioButton.isSelected());
        ExpCurve[] expCurves = romHandler.getExpCurves();
        settings.setSelectedEXPCurve(expCurves[secEXPCurveComboBox.getSelectedIndex()]);
        ...
        settings.setAbilitiesMod(saUnchangedRadioButton.isSelected(), saRandomRadioButton.isSelected());
        settings.setAllowWonderGuard(saBanWonderGuardCheckBox.isSelected());
        settings.setAbilitiesFollowEvolutions(saFollowEvolutionsCheckBox.isSelected());
        settings.setBanTrappingAbilities(saBanTrappingAbilitiesCheckBox.isSelected());
        settings.setBanNegativeAbilities(saBanNegativeAbilitiesCheckBox.isSelected());
        settings.setBanBadAbilities(saBanMinorAbilitiesCheckBox.isSelected());
        settings.setAbilitiesFollowMegaEvolutions(saFollowMegaEvosCheckBox.isSelected());
        settings.setWeighDuplicateAbilitiesTogether(saWeighDuplicatesTogetherCheckBox.isSelected());
        settings.setEnsureTwoAbilities(saForceTwoAbilitiesCheckbox.isSelected());

        settings.setSpeciesTypesMod(stUnchangedRadioButton.isSelected(), stRandomFollowEvolutionsRadioButton.isSelected(),
                stRandomCompletelyRadioButton.isSelected());
        settings.setTypesFollowMegaEvolutions(stFollowMegaEvosCheckBox.isSelected() && stFollowMegaEvosCheckBox.isVisible());
        settings.setBlockBrokenMovesetMoves(pmsNoGameBreakingMovesCheckBox.isSelected());
        settings.setDualTypeOnly(stForceDualTypeCheckBox.isSelected());
        ...
        settings.setUseTimeBasedEncounters(wpRemoveTimeBasedEncountersCheckBox.isSelected());
        ...
        settings.setTmsMod(tmmUnchangedRadioButton.isSelected(), tmmRandomRadioButton.isSelected());
        ...
        settings.setTmLevelUpMoveSanity(thcLevelupMoveSanityCheckBox.isSelected());
        settings.setKeepFieldMoveTMs(tmmKeepFieldMoveTMsCheckBox.isSelected());
        settings.setFullHMCompat(thcFullHMCompatibilityCheckBox.isSelected() && thcFullHMCompatibilityCheckBox.isVisible());
        settings.setTmsForceGoodDamaging(tmmForceGoodDamagingCheckBox.isSelected());
        settings.setTmsGoodDamagingPercent(tmmForceGoodDamagingSpinSlider.getValue());
        settings.setBlockBrokenTMMoves(tmmNoGameBreakingMovesCheckBox.isSelected());
        settings.setTmsFollowEvolutions(thcFollowEvolutionsCheckBox.isSelected());

        settings.setMoveTutorMovesMod(mtmUnchangedRadioButton.isSelected(), mtmRandomRadioButton.isSelected());
        ...
        settings.setTutorLevelUpMoveSanity(mtcLevelupMoveSanityCheckBox.isSelected());
        settings.setKeepFieldMoveTutors(mtmKeepFieldMoveTutorsCheckBox.isSelected());
        settings.setTutorsForceGoodDamaging(mtmForceGoodDamagingCheckBox.isSelected());
        settings.setTutorsGoodDamagingPercent(mtmForceGoodDamagingSpinSlider.getValue());
        settings.setBlockBrokenTutorMoves(mtmNoGameBreakingMovesCheckBox.isSelected());
        settings.setTutorFollowEvolutions(mtcFollowEvolutionsCheckBox.isSelected());
