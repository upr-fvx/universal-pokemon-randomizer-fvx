...
public class RandomizationLogger {
    ...
    private void logInGameTrades(List<InGameTrade> oldTrades) {
        ...
        for (int i = 0; i < oldTrades.size(); i++) {
            ...
            table.addRow(
                    oldT.getRequestedSpecies().getFullName(), oldT.getGivenSpecies().getFullName(), oldT.getNickname(),
                    newT.getRequestedSpecies().getFullName(), newT.getGivenSpecies().getFullName(), newT.getNickname()
            );
        }
        log.print(table);
