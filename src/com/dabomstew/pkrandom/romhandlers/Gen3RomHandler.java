...
public class Gen3RomHandler extends AbstractGBRomHandler {
    ...
    public List<StaticEncounter> getStaticPokemon() {
        ...
        for (int i = 0; i < staticsHere.size(); i++) {
            ...
            se.setPkmn(staticPK.getPokemon(this));
    ...
    public boolean setStaticPokemon(List<StaticEncounter> staticPokemon) {
        ...
        for (int i = 0; i < staticsHere.size(); i++) {
            staticsHere.get(i).setPokemon(this, staticPokemon.get(i).getPkmn());
        ...
        if (romEntry.hasTweakFile("StaticFirstBattleTweak")) {
            ...
            int startingSpeciesOffset = romEntry.getIntValue("StaticFirstBattleSpeciesOffset");
            writeWord(startingSpeciesOffset, pokedexToInternal[startingFirstBattle.getPkmn().getNumber()]);
            int startingLevelOffset = romEntry.getIntValue("StaticFirstBattleLevelOffset");
            ...
            for (int offset : ghostMarowakSpeciesOffsets) {
                writeWord(offset, pokedexToInternal[ghostMarowak.getPkmn().getNumber()]);
            }
            ...
            if (ghostMarowak.getPkmn().getGenderRatio() == 0 || ghostMarowak.getPkmn().getGenderRatio() == 0xFF) {
                // 0x00 is 100% male, and 0xFF is indeterminate gender
                writeByte(ghostMarowakGenderOffset, (byte) ghostMarowak.getPkmn().getGenderRatio());
            }
        }
    ...
    private void getRoamers(List<StaticEncounter> statics) throws IOException {
        if (romEntry.getRomType() == Gen3Constants.RomType_Ruby) {
            ...
            StaticEncounter se = new StaticEncounter();
            se.setPkmn(roamer.getPokemon(this));
    ...
    private void setRoamers(List<StaticEncounter> statics) {
        if (romEntry.getRomType() == Gen3Constants.RomType_Ruby || romEntry.getRomType() == Gen3Constants.RomType_Sapp) {
            ...
            StaticPokemon roamer = romEntry.getRoamingPokemon().get(0);
            roamer.setPokemon(this, roamerEncounter.getPkmn());
            ...
            if (pkmn != null) {
                for (Evolution evo : pkmn.getEvolutionsFrom()) {
                    ...
                    if (evo.getType() == EvolutionType.HAPPINESS_DAY && romEntry.getRomType() == Gen3Constants.RomType_FRLG) {
                        ...
                        addEvoUpdateStone(impossibleEvolutionUpdates, evo, items.get(Gen3ItemIDs.sunStone));
                    }
                    if (evo.getType() == EvolutionType.HAPPINESS_NIGHT && romEntry.getRomType() == Gen3Constants.RomType_FRLG) {
                        ...
                        addEvoUpdateStone(impossibleEvolutionUpdates, evo, items.get(Gen3ItemIDs.moonStone));
                    }
                    ...
                    if (evo.getType() == EvolutionType.TRADE_ITEM) {
                        if (evo.getFrom().getNumber() == SpeciesIDs.poliwhirl) {
                            ...
                            addEvoUpdateStone(impossibleEvolutionUpdates, evo, items.get(Gen3ItemIDs.waterStone));
            ...
            if (pkmn != null) {
                for (Evolution evol : pkmn.getEvolutionsFrom()) {
                    ...
                    if (evol.getType() == EvolutionType.HAPPINESS_DAY) {
                        ...
                        addEvoUpdateStone(timeBasedEvolutionUpdates, evol, items.get(evol.getExtraInfo()));
    ...
    public int getAbilityForTrainerPokemon(TrainerPokemon tp) {
        ...
        return tp.getSpecies().getAbility1();
    }
