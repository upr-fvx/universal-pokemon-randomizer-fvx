        ...
        try {
            ...
            for (int i = 1; i < trainernum; i++) {
                ...
                for (int poke = 0; poke < numPokes; poke++) {
                    ...
                    tpk.setHasMegaStone(Gen6Constants.isMegaStone(tpk.getHeldItem().getId())); // TODO: better way of recognizing mega stones
        ...
        try {
            ...
            for (int i: totemIndices) {
                ...
                for (int j = 0; j < allies; j++) {
                    ...
                    totem.getAllies().put(allyIndex,readStaticEncounter(staticEncountersFile, allyIndex * 0x38));
                }
                totems.add(totem);
            }
        } catch (IOException e) {
