...
import com.upr_fvx.pkromio.gamedata.cueh.BasicSpeciesAction;
import com.upr_fvx.pkromio.gamedata.cueh.EvolvedSpeciesAction;
import com.upr_fvx.pkromio.graphics.palettes.*;
...
public class Gen3to5PaletteRandomizer extends PaletteRandomizer {
	...
	private String getResourceAddress(String fileKey) {
		return "/com/upr_fvx/pkromio/graphics/" + getFileName(fileKey);
	}

	private String getSourceFileAddress(String fileKey) {
		return "src/main/java/resources/com/upr_fvx/pkromio/graphics/" + getFileName(fileKey);
	}
