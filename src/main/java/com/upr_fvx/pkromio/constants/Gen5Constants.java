package com.upr_fvx.pkromio.constants;
...
//    public static final Map<Integer, String> bw1ShopIndex = new HashMap<Integer, String>() {1:"Check"};
    ...
    public static void tagTrainersBW2(List<Trainer> trs) {
        ...
        tag(trs, "GYM1-NOTSTRONG", 0x32E); // the initial PWT fight
        ...
        tag(trs, "THEMED:COLRESS-STRONG", 0x166, 0x158, 0x32d);
        tag(trs, "THEMED:COLRESS-STRONG-NOTSTRONG", 0x32f); // the initial PWT fight
