...
import static compressors.CmpTestConstants.*;

public class Gen1CmpTest {
    // These tests don't work for now since they depend on GBCImage,
    // which resides outside the utils module.
    // TODO: rewrite tests so they can be uncommented

    @Test
    public void dummyTest() {
        System.out.println("foobar");
        assertTrue("foobar".equals("foobaz"));
        // Does nothing, is just here so gradle doesn't complain about these text files being "empty"
    }
